...
if(isset($_POST['update']))
{
    ...
    // Update query
    $query = mysqli_query($con,"UPDATE tblcontactus 
    ...
    {
        // Fetch user email
        $result = mysqli_query($con,"SELECT fullname,email,message FROM tblcontactus WHERE id='$qid'");
        ...
        try {
            ...
            $mail->isHTML(true);
            $mail->Subject = 'Reply to Your Query - HDIMS';
            ...
            $mail->Body = "
                ...
                <p>$adminremark</p>
                <br>
                <p>Regards,<br><b>HDIMS Support Team</b></p>
            ";
    ...
    exit;
        ...
        echo "<script>alert('Admin Remark updated and email sent successfully.');</script>";
